    ...
    <div className="dashboardLayout">
      ...
      <div className="mainArea">
        ...
        <div className="pageContent">
          <h1>2FA Tool - Refund</h1>
          <p>Process refunds with two-factor authentication verification.</p>
          
          <div className="formSection" style={{marginTop: '20px', maxWidth: '500px'}}>
            <div className="formRow" style={{marginBottom: '15px'}}>
              <label style={{display: 'block', marginBottom: '5px', fontWeight: 500}}>Request ID</label>
              <input type="text" placeholder="Enter request ID" style={{width: '100%', padding: '10px', borderRadius: '6px', border: '1px solid #ddd'}} />
            </div>
